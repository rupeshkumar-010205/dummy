...
from data.metrics import plt_settings
...
def plot_labels(boxes, cls, names=(), save_dir=Path(""), on_plot=None):
    ...
    import pandas  # scope for faster 'import  '
    import seaborn  # scope for faster 'import  '
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Example:
        ```python
        from  .utils.plotting import save_one_box
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/ /yolov5/issues/7007 chroma subsampling issue
